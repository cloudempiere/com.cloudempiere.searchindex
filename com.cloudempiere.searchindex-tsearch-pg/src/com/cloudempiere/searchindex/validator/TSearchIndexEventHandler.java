 ...
 **********************************************************************/
package com.cloudempiere.searchindex.validator;
...
public class TSearchIndexEventHandler extends AbstractEventHandler {
	...
	protected void initialize() {
		...
		List<String> indexedTables = SearchIndexHelper.getIndexedTableNames(trxName, -1); // CLDE this gets data from all clients
		...
		fkTableNames = SearchIndexHelper.getForeignTableNames(trxName, -1); // CLDE - this gets data from all clients
		//Index the FK tables
		...
		// CLDE -Handle the changes in the Search Index Config to update the index
...
//			SearchIndexHelper.deleteFromDocument(SearchIndexAbstractFactory.TEXTSEARCH_INDEX, po);
//		else 
//			SearchIndexHelper.updateDocument(SearchIndexAbstractFactory.TEXTSEARCH_INDEX, po, 
