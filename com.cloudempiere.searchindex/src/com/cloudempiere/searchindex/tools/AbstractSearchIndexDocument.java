...
public abstract class AbstractSearchIndexDocument implements SearchIndexDocument {

	/**	Logger							*/
	protected static CLogger log = CLogger.getCLogger (AbstractSearchIndexDocument.class);
